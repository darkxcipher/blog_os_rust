...
use core::prelude::rust_2024::test_case;
...
pub fn print_something(){
    ...
    writer.write_string("xllo");
    write!(writer, "tje numbers are {} and {}", 41, 1.0/2.3).unwrap();
}
*/
use core::fmt;
...
///The VGA text buffer is a two-dimensional array with typically 25 rows and 80 columns, 
///which is directly rendered to the screen.
